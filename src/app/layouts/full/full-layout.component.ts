...
import { initializeApps, initializeCurrentApp, initializeInfo } from "app/shared-functions";
...
export class FullLayoutComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  async ngOnInit() {
    ...
    console.log('full layout component')
    await initializeCurrentApp(this.applicationService)
    await initializeApps(this.applicationService)
